...
<div class="row">
	<div class="span8">
		...
		<p>
			The network is composed of nodes and the encrypted tunnels between them. These tunnels travel over
			both traditional internet infrastructure and wireless networks, where available. 
		</p>
		<p>
			The Hyperboria network is part of an international effort to protect free speech, called 
			<a href="http://projectmeshnet.org">Project Meshnet</a>.
		</p>
	</div>
	<div class="span4">
		<img src="/images/network_.png">
	</div>
</div></header>
<br><br><br><br>
<div class="row centered">
	...
	<div class="span4">
		<div class="col-wrap">
			...
			A node is a connected CJDNS router.
		</p>
		<p>
			To be precise, a node is a device with CJDNS installed, configued and connected to some peers.
		</p>
	...
	<div class="span4">
		<div class="col-wrap">
				...
				<h2></h2>
				<p>
			All sorts of devices can be used as nodes.
		</p>
		<p>
			For example, a device can be an actual router (with OpenWRT), possibly a wireless router.
			Or it can be a PC or server with a local CJDNS installation.
		</p>
	...
	<div class="span4">
		...
		<p>
			To connect to Hyperboria, you need to set up a node and connect to some trusted peers.
			You can find more information and tutorials on getting connected   
		</p>
		</div>
	</div>
