...
<!--[if gt IE 8]><!--> <html class="no-js" lang="<?=$locale?>"> <!--<![endif]-->
	<head>
		...
		<body>
		<!--[if lt IE 7]>
			<p class=chromeframe><?=_("Your browser is insecure, ugly, downright mean to developers and most of all <em>ancient!</em>")?>
			<a href="http://browsehappy.com/"><?=_("Upgrade to a different browser")?></a> <?=_("or")?>
			<a href="http://www.google.com/chromeframe/?redirect=true"><?=("install Google Chrome Frame")?></a>
			<?=_("to experience this site the way modern people do.")?></p>
		<![endif]-->
		...
		<div class="container">
			...
			<footer>
				<p>
					<?=_("This")?> <span xmlns:dct="http://purl.org/dc/terms/" 
					href="http://purl.org/dc/dcmitype/InteractiveResource" rel="dct:type"><?=_("work")?></span>
					<?=_("is licensed under a")?> <a rel="license" href="http://creativecommons.org/licenses/by/3.0/">
					Creative Commons Attribution 3.0 Unported License</a>.
				</p>
				<p><?=_("Hyperboria is a part of")?> <a href="http://projectmeshnet.org">ProjectMeshnet</a>.</p>
			</footer>
		</div> <!-- /container -->
		<!-- Scripts -->
